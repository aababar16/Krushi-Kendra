...
if(request.getParameter("b1")!=null) 
{
	...
	ResultSet rs=db.getRows("select * from Users where MobileNo='"+session.getAttribute("user")+"' and Password='"+old+"'");
	if(!rs.next())
	{
	...
	else
	{
		...
		{
			db.executeSql("Update Users set Password=? where MobileNo=?",new1,session.getAttribute("user").toString());
